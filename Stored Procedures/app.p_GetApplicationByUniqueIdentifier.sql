...
CREATE PROCEDURE [app].[p_GetApplicationByUniqueIdentifier]
...
EXEC	[app].[p_GetApplicationByUniqueIdentifier]
		@UniqueIdentifier = 1
...
GO
GRANT EXECUTE ON  [app].[p_GetApplicationByUniqueIdentifier] TO [ExecSP]
GO
