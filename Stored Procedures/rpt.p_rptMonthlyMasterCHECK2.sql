...
--exec [rpt].[p_rptMonthlyMasterCHECK2] 
...
CREATE PROCEDURE [rpt].[p_rptMonthlyMasterCHECK2] 
AS
BEGIN
-- =============================================
-- Author:		Andre Barber
...
--with rollup	
--order by 'error' desc --#Output.acct -- #Output.acct --#Output.Name		 --'error'
having
abs(((#Output.[Original Principal]-	sum(#LoanPivotPaidTotals.Principal) - (isnull(#Loan1PivotCurrent.[Principal Balance],0) + isnull(#Loan2PivotCurrent.[Principal Balance],0))) ) )>0.0
