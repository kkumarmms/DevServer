...
CREATE PROCEDURE [fn].[p_GetLoanSummaryAll] 
as
/***
	Author: Mike Sherman
	Date:  2014/03/20
	Desc:  get summary information of the current state of each loan for ALL user
			populate invoice stage table

	exec fn.p_GetLoanSummary 3263--3240
...
begin try
 ...
 FROM  (
		...
		where	s.LoanYear = 255 --and c.userid = 3263
