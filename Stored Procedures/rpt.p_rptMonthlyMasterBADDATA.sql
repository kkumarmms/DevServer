...
--exec [rpt].[p_rptMonthlyMasterBADDATA] 
...
CREATE PROCEDURE [rpt].[p_rptMonthlyMasterBADDATA] 
AS
BEGIN
-- =============================================
-- Author:		Andre Barber
...
,isnull(#Output.[Original Principal],0)-sum(isnull(#LoanPivotPaidTotals.Principal,0)) - (isnull(#Loan1PivotCurrent.[Principal Balance],0) + isnull(#Loan2PivotCurrent.[Principal Balance],0)) as 'ERROR'	
from #LoanPivotPaidTotals	
	...
	--BAD DATA
	--Where #Output.Acct in (904,1819,705) --debug
	--Where #Output.[Original Principal]>(sum(#LoanPivotPaidTotals.Principal) + isnull(#Loan1PivotCurrent.[Principal Balance],0) + isnull(#Loan2PivotCurrent.[Principal Balance],0))
	--where isnull(#Output.[Original Principal],0)-sum(isnull(#LoanPivotPaidTotals.Principal,0)) - (isnull(#Loan1PivotCurrent.[Principal Balance],0) + isnull(#Loan2PivotCurrent.[Principal Balance],0))=0.00
