...
--Mike generate monthly invoice
--select * from  fn.invoices.InvoiceCUrrentFlag=0
--select * from  fn.invoices_stage
--where USERID in (2782,2238)
...
CREATE PROCEDURE [rpt].[p_rptInvoicesCalcs] 
...
-- 3 invoices 
-- Use Mike's table select * from  fn.invoices.Invoice where CurrentFlag=0
...
-- TODO apply where CurrentFlag=0 criteria once fn.invoices is populated
-- =============================================
...
,fn.invoices_stage.PrincipalDue
,fn.invoices_stage.PrincipalOverdue
,fn.invoices_stage.InterestDue
,fn.invoices_stage.InterestOverdue
--,fn.invoices_stage
--,fn.invoices_stage
--,fn.invoices_stage
--,fn.invoices_stage

from fn.invoices_stage inner join #LoanPivotPaidTotals  on fn.invoices_stage.userid=#LoanPivotPaidTotals.userid	
	...
	where isnull(#Output.Acct,0)<>0
	 and #Output.Acct in (2782,2238) -->=2476
