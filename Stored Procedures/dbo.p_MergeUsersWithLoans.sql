...
SET ANSI_NULLS ON
GO
Create PROCEDURE [dbo].[p_MergeUsersWithLoans] 
	@MergeWhat int, 
	@mergeTo int
as
/***
	...
	select * from app.applications where userid = 
	[p_MergeUsersWithLoans] 3390 , 3241
	[p_MergeUsersWithLoans] 3434 , 3121
	[p_MergeUsersWithLoans] 3429 , 3252
	[p_MergeUsersWithLoans] 3415  , 3232
***/
